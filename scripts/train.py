...
if __name__ == "__main__":
    args = parse_args()
    args.config_file = 'config-files/crowdai-small_hrnet48.yaml'
    args.opt = None
    cfg.merge_from_file(args.config_file) #config dosyası
    cfg.merge_from_list(args.opts) # ekstra paramlar eklenecek ise veya değiştirilecekse ekleniyor.
    cfg.freeze()
